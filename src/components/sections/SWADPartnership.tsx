...
export default function SWADPartnership() {
  ...
  <Reveal>
    <div
      className="flex flex-col sm:flex-row items-center justify-between gap-8 p-10"
      style={{
    ...
    >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex-shrink-0 inline-flex items-center gap-3 px-8 py-4 font-semibold transition-all duration-200 hover:scale-105"
        style={{
